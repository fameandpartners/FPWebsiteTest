...
def main(argv):
    try:
        ...
        user = driver.find_element_by_xpath(
            '/html[1]/body[1]/div[3]/div[1]/header[1]/nav[1]/ul[2]/li[1]/div[1]/span[1]/a[1]')
        ...
        click(
            driver,
            "/html[1]/body[1]/div[3]/div[1]/footer[1]/div[1]/div[4]/ul[1]/li[8]/a[1]",
            'xpath',
            log)
        check_url(driver, base_url + 'contact', log)
        ...
        select = driver.find_element_by_xpath(
            "/html[1]/body[1]/div[3]/div[1]/footer[1]/div[1]/div[6]/form[1]/div[1]/select[1]")
        ...
        click(
            driver,
            "/html[1]/body[1]/div[3]/div[1]/footer[1]/div[1]/div[3]/div[1]/a[1]/*",
            'xpath',
            log)
        ...
        click(
            driver,
            "/html[1]/body[1]/div[3]/div[1]/footer[1]/div[1]/div[3]/div[1]/a[2]/*",
            'xpath',
            log)
        ...
        click(
            driver,
            "/html[1]/body[1]/div[3]/div[1]/footer[1]/div[1]/div[3]/div[1]/a[3]/*",
            'xpath',
            log)
