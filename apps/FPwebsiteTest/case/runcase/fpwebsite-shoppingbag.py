...
def shopping_bag(argv):
    try:
        ...
        driver.get(url+'dresses/custom-dress-FPG1145~101~1119~CM')
        sleep(5, log)
        ...
        click(driver, "//*[@id='root']/main/div[1]/div[2]/div/button", 'xpath', log)
        sleep(5, log)
        assert_text(driver, '2', 'xpath', '//*[@id="portal-root"]/div[4]/div/div/div/div/div[1]/span', log,
                    '购物车页面衣服详情字段[衣服数量]显示正确', '购物车页面衣服详情字段[衣服数量]显示错误')
        assert_text(driver, 'Drape Front Set', 'xpath', '//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li[2]/div[2]/p/strong', log,
        ...
        price1 = find_element(driver,'//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li[1]/div[2]/p/span/span/span',
                              'xpath',log).text
        price2 = find_element(driver,'//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li[2]/div[2]/p/span/span/span',
                              'xpath',log).text
        total_price = find_element(driver,'//*[@id="portal-root"]/div[4]/div/div/div/div/div[2]/div/span[2]/span/span',
                              'xpath',log).text
        price1 = price1[1:]
        price2 = price2[1:]
        ...
        click(driver, '//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li[1]/div[1]/a[2]/span',
              'xpath', log)
        sleep(5, log)
        assert_text(driver, '1', 'xpath', '//*[@id="portal-root"]/div[4]/div/div/div/div/div[1]/span', log,
                    '购物车页面衣服详情字段[衣服数量]显示正确', '购物车页面衣服详情字段[衣服数量]显示错误')
        assert_text(driver, 'Drape Front Set', 'xpath', '//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li/div[2]/p/strong', log,
        ...
        price1 = find_element(driver, '//*[@id="portal-root"]/div[4]/div/div/div/div/ul/li/div[2]/p/span/span/span',
                              'xpath', log).text
        total_price = find_element(driver, '//*[@id="portal-root"]/div[4]/div/div/div/div/div[2]/div/span[2]/span/span',
                                   'xpath', log).text
        price1 = price1[1:]
