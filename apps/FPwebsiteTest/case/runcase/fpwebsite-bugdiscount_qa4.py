...
def main(argv):
    ...
    for i in range(1, 21):
        if i == 1 and products_active[i] == 1:
            ...
            text_xp = find_element(driver, '/html[1]/body[1]/div[1]/div[1]/header[1]/nav[1]/ul[2]/div[1]', 'xpath', log)
        elif products_active[i] == 1:
            search_btn = find_element(driver, '//*[@id="root"]/header/nav/ul[2]/li[2]/a', 'xpath', log)
            driver.execute_script('arguments[0].click()', search_btn)
            text_xp = find_element(driver, '/html[1]/body[1]/div[1]/header[1]/nav[1]/ul[2]/div[1]', 'xpath', log)
        else:
